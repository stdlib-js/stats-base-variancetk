...
```javascript
variancetk = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-variancetk@v0.0.11-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-variancetk@v0.0.11-umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/stats-base-variancetk/actions/workflows/test.yml/badge.svg?branch=v0.0.11
[test-url]: https://github.com/stdlib-js/stats-base-variancetk/actions/workflows/test.yml?query=branch:v0.0.11
